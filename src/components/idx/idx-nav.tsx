...
import { Building2, Filter, Network, Search } from "lucide-react";
...
export function IdxNav() {
	...
	return (
		<div className="mb-5 flex items-center gap-1 border-b border-white/[0.06] pb-3">
			{IDX_LINKS.map((link) => {
				...
				return (
					<Link
						...
						to={link.to}
						className={clsx(
							"group flex items-center gap-1.5 rounded-lg px-3 py-1.5 font-mono text-[11px] uppercase tracking-[0.16em] transition-all",
							active
